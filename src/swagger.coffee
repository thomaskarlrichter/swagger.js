...
class SwaggerOperation
  ...
  constructor: (@nickname, @path, @httpMethod, @parameters=[], @summary, @notes, @examples, @responseClass, @errorResponses, @resource, @consumes, @produces) ->
    ...
    for param in @parameters
      if param.paramType == 'path'
        ...
        if args[param.name]
          ...
          # arangodb uses slashs in paramname 
